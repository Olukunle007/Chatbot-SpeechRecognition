...
# ----------------------------------- STREAMLIT DESIGN -----------------------
st.markdown("<h1 style = 'text-align: center; color: #176B87'>MENTAL HEALTH CHATBOT WITH SPEECH RECOGNITION</h1>", unsafe_allow_html = True)
st.markdown("<h6 style = 'text-align: center; top-margin: 0rem; color: #64CCC5'>BUILT BY Olukunle Olukini</h1>", unsafe_allow_html = True)

st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('pngwing.com (1).png', caption = 'Mental Health Related Chats')
